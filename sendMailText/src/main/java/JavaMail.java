...
public class JavaMail {
    ...
    public JavaMail(boolean debug) {
        InputStream in = JavaMail.class.getResourceAsStream("test.properties");
        try {
            properties.load(in);
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
        ...
        try {
            ...
            */
            ...
            InternetAddress[] iaToList = new InternetAddress().parse(receiveUser);
    ...
    public static void main(String[] args) {
        ...
        String to[]={"xxxxx@qq.com","yyyyy@133.com"};
        String toList = getMailList(to);
        se.doSendHtmlEmail("邮件主题123", "test邮件内容\\n\\r  <br> 999", toList);
    }
}